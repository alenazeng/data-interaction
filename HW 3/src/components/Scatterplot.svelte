        ...
        enter => enter.append("circle")
          ...
          .attr("fill", d => {
            if (!selectedCommunity) {
              return highlightedCities.includes(d.city_name)
                ? "crimson"
                : "steelblue";
            }

            return d.community_name === selectedCommunity
              ? "crimson"
              : "#d3d3d3";
          })
          .attr("opacity", d => {
            if (!selectedCommunity) return 0.8;
          ...
          .attr("stroke", d =>
            d.community_name === selectedCommunity
              ? "black"
              : "none"
          )
          .attr("stroke-width", d =>
